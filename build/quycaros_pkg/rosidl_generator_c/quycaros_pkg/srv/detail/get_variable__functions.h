...
#ifndef QUYCAROS_PKG__SRV__DETAIL__GET_VARIABLE__FUNCTIONS_H_
#define QUYCAROS_PKG__SRV__DETAIL__GET_VARIABLE__FUNCTIONS_H_
 ...
 * calls
 * quycaros_pkg__srv__GetVariable_Request__init().
...
/**
 * It calls
 * quycaros_pkg__srv__GetVariable_Request__fini()
 ...
 * quycaros_pkg__srv__GetVariable_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * quycaros_pkg__srv__GetVariable_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * quycaros_pkg__srv__GetVariable_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_quycaros_pkg
...
/**
 * It calls
 * quycaros_pkg__srv__GetVariable_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_quycaros_pkg
...
/**
 * It allocates the memory for the array and calls
 * quycaros_pkg__srv__GetVariable_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_quycaros_pkg
...
/**
 * It calls
 * quycaros_pkg__srv__GetVariable_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // QUYCAROS_PKG__SRV__DETAIL__GET_VARIABLE__FUNCTIONS_H_
