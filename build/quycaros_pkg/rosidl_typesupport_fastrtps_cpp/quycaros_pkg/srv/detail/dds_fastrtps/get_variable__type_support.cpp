...
#include "quycaros_pkg/srv/detail/get_variable__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = quycaros_pkg::srv::GetVariable_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const quycaros_pkg::srv::GetVariable_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<quycaros_pkg::srv::GetVariable_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetVariable_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const quycaros_pkg::srv::GetVariable_Request *>(
...
static size_t _GetVariable_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetVariable_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetVariable_Request__callbacks = {
  "quycaros_pkg::srv",
  "GetVariable_Request",
...
static rosidl_message_type_support_t _GetVariable_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetVariable_Request__callbacks,
...
{
  return &quycaros_pkg::srv::typesupport_fastrtps_cpp::_GetVariable_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = quycaros_pkg::srv::GetVariable_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const quycaros_pkg::srv::GetVariable_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<quycaros_pkg::srv::GetVariable_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetVariable_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const quycaros_pkg::srv::GetVariable_Response *>(
...
static size_t _GetVariable_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetVariable_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetVariable_Response__callbacks = {
  "quycaros_pkg::srv",
...
static rosidl_message_type_support_t _GetVariable_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetVariable_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &quycaros_pkg::srv::typesupport_fastrtps_cpp::_GetVariable_Response__handle;
}
...
static service_type_support_callbacks_t _GetVariable__callbacks = {
  "quycaros_pkg::srv",
  "GetVariable",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quycaros_pkg, srv, GetVariable_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quycaros_pkg, srv, GetVariable_Response)(),
...
static rosidl_service_type_support_t _GetVariable__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetVariable__callbacks,
...
{
  return &quycaros_pkg::srv::typesupport_fastrtps_cpp::_GetVariable__handle;
}
