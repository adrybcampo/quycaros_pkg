...
static const _ControlMsg_type_support_symbol_names_t _ControlMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quycaros_pkg, msg, ControlMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quycaros_pkg, msg, ControlMsg)),
  }
};
...
{
  return &::quycaros_pkg::msg::rosidl_typesupport_cpp::ControlMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, quycaros_pkg, msg, ControlMsg)() {
  return get_message_type_support_handle<quycaros_pkg::msg::ControlMsg>();
}
