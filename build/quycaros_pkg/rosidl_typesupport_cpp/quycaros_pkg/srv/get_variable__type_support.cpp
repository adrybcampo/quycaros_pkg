...
static const _GetVariable_Request_type_support_symbol_names_t _GetVariable_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quycaros_pkg, srv, GetVariable_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quycaros_pkg, srv, GetVariable_Request)),
  }
};
...
{
  return &::quycaros_pkg::srv::rosidl_typesupport_cpp::GetVariable_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, quycaros_pkg, srv, GetVariable_Request)() {
  return get_message_type_support_handle<quycaros_pkg::srv::GetVariable_Request>();
}
...
static const _GetVariable_Response_type_support_symbol_names_t _GetVariable_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quycaros_pkg, srv, GetVariable_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quycaros_pkg, srv, GetVariable_Response)),
  }
};
...
{
  return &::quycaros_pkg::srv::rosidl_typesupport_cpp::GetVariable_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, quycaros_pkg, srv, GetVariable_Response)() {
  return get_message_type_support_handle<quycaros_pkg::srv::GetVariable_Response>();
}
...
static const _GetVariable_type_support_symbol_names_t _GetVariable_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quycaros_pkg, srv, GetVariable)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quycaros_pkg, srv, GetVariable)),
  }
};
...
{
  return &::quycaros_pkg::srv::rosidl_typesupport_cpp::GetVariable_service_type_support_handle;
}
