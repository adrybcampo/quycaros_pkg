...
#include "quycaros_pkg/srv/detail/set_variable__rosidl_typesupport_fastrtps_c.h"
...
using _SetVariable_Request__ros_msg_type = quycaros_pkg__srv__SetVariable_Request;
...
size_t get_serialized_size_quycaros_pkg__srv__SetVariable_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetVariable_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_quycaros_pkg__srv__SetVariable_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_quycaros_pkg
size_t max_serialized_size_quycaros_pkg__srv__SetVariable_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = quycaros_pkg__srv__SetVariable_Request;
    is_plain =
      (
...
static size_t _SetVariable_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_quycaros_pkg__srv__SetVariable_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, quycaros_pkg, srv, SetVariable_Request)() {
...
using _SetVariable_Response__ros_msg_type = quycaros_pkg__srv__SetVariable_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_quycaros_pkg
size_t get_serialized_size_quycaros_pkg__srv__SetVariable_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetVariable_Response__ros_msg_type * ros_message = static_cast<const _SetVariable_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_quycaros_pkg__srv__SetVariable_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_quycaros_pkg
size_t max_serialized_size_quycaros_pkg__srv__SetVariable_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = quycaros_pkg__srv__SetVariable_Response;
    is_plain =
      (
...
static size_t _SetVariable_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_quycaros_pkg__srv__SetVariable_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, quycaros_pkg, srv, SetVariable_Response)() {
...
// already included above
// #include "quycaros_pkg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "quycaros_pkg/srv/set_variable.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, quycaros_pkg, srv, SetVariable)() {
